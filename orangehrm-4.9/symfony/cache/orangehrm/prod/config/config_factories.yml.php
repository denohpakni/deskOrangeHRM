...
// date: 2021/12/01 10:56:39
  ...
  {
    $class = sfConfig::get('sf_factory_i18n', 'ohrmI18N');
    $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\xampp\\htdocs\\orangeHRM\\orangehrm-4.9\\symfony\\cache\\orangehrm\\prod\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\xampp\\htdocs\\orangeHRM\\orangehrm-4.9\\symfony\\apps\\orangehrm/i18n',
));
...
if ($parameters = $this->factories['routing']->parse($this->factories['request']->getPathInfo()))
{
  ...
  $class = sfConfig::get('sf_factory_storage', 'ohrmSessionStorage');
  $this->factories['storage'] = new $class(array_merge(array(
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('orangehrm'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\xampp\\htdocs\\orangeHRM\\orangehrm-4.9\\symfony\\cache\\orangehrm\\prod\\template',
  'lifetime' => 86400,
  'prefix' => 'C:\\xampp\\htdocs\\orangeHRM\\orangehrm-4.9\\symfony\\apps\\orangehrm/template',
)));
